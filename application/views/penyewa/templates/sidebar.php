                ...
                <div class="sidebar-content">
                    <ul class="nav nav-secondary">
                        ...
                        <li class="nav-item <?= ($segment == '' || $segment == 'dashboard') ? 'active' : ''; ?>">
                            <a href="<?= base_url('penyewa') ?>" class="collapsed" aria-expanded="false">
                                <i class="fas fa-home"></i>
                                <p>Dashboard</p>
                            </a>
                        </li>
                        <li class="nav-item <?= ($segment == 'sewa') ? 'active' : ''; ?>">
                            <a href="<?= base_url('penyewa/sewa') ?>" class="collapsed" aria-expanded="false">
                                <i class="bi bi-house"></i>
                                <p>Sewa</p>
                            </a>
                        </li>

                        <!-- <li class="nav-item <?= ($segment == 'tanya') ? 'active' : ''; ?>">
                            <a href="<?= base_url('penyewa/tanya') ?>" class="collapsed" aria-expanded="false">
                                <i class="bi bi-cash"></i>
                                <p>Tanya Kami</p>
                            </a>
                        </li> -->
                        <li class="nav-item <?= ($segment == 'riwayat') ? 'active' : ''; ?>">
                            <a href="<?= base_url('penyewa/riwayat') ?>" class="collapsed" aria-expanded="false">
                                <i class="fas fa-file"></i>
                                <p>Riwayat Sewa</p>
                            </a>
                        </li>
                        <li class="nav-item <?= ($segment == 'keluhan') ? 'active' : ''; ?>">
                            <a href="<?= base_url('penyewa/keluhan') ?>" class="collapsed" aria-expanded="false">
                                        ...
                                        <li>
                                            <div class="user-box">
                                                ...
                                                <div class="u-text">
                                                    ...
                                                    <a href="<?= base_url('penyewa/profile') ?>" class="btn btn-xs btn-secondary btn-sm">Lihat Profil</a>
                                                </div>
                                            </div>
                                        </li>
                                        <li>
